      ...
      .then(function (imageUrls) {
        ...
        $.ajax({
          ...
          success: function (res) {
            ...
            // Agrega el producto al array global y fuerza reagrupado
            const newProd = new Product(formData);
            self.products().push(newProd);

            // Si hay un método para reagrupar o refrescar la vista principal, notifícalo
            if (typeof self.products.valueHasMutated === "function") {
              self.products.valueHasMutated(); // fuerza a KO a reevaluar bindings
            }
